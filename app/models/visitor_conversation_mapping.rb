...
class VisitorConversationMapping
  ...
  class << self
    ...
    def clear_visitor_data(visitor_id, website_token)
      ...
      keys = [
        format(VISITOR_CONVERSATION_MAPPING, visitor_id: visitor_id, website_token: website_token),
        format(VISITOR_CONTACT_MAPPING, visitor_id: visitor_id, website_token: website_token),
        format(VISITOR_PAGE_INFO, visitor_id: visitor_id, website_token: website_token)
      ]
