...
Write-Host "BUILD: Building and starting services..." -ForegroundColor Blue
...
Write-Host "`nREADY: Development Environment Ready!" -ForegroundColor Green
...
Write-Host "`nFRONTEND: To start Vite (Frontend Development):" -ForegroundColor Yellow
